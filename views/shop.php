                            ...
                            <div class="col-xl-3">
                                <div class="bg-light ps-3 py-3 rounded d-flex justify-content-between mb-4">
                                    ...
                                    <label for="fruits">Danh mục:</label>
                                        ...
                                        <select id="category" name="category" class="border-0 form-select-sm bg-light me-3" onchange="this.form.submit()">

                                            <option value="">All</option>
                                            <?php foreach ($danhmuc as $dm) { ?>
                                                <option value="<?= $dm['id'] ?>" <?= (isset($_GET['category']) && $_GET['category'] == $dm['id']) ? 'selected' : '' ?>>
                                                    <?= $dm['name'] ?>
                                                </option>
                                            <?php } ?>
                                        </select>
