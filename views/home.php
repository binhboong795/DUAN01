                                        ...
                                        <div class="col-md-6 col-lg-4 col-xl-3">                      
                                            <div class="rounded position-relative fruite-item">
                                                <div class="fruite-img">
                                                    <img src="assets/img/<?=$rows['img']?>" class="img-fluid w-100 rounded-top" alt="">
                                                </div>
                                                <div class="text-white bg-secondary px-3 py-1 rounded position-absolute" style="top: 10px; left: 10px;">Fruits</div>
                                                <div class="p-4 border border-secondary border-top-0 rounded-bottom">

                                                <h4><a class="linkpro" href="?act=shopdetail&id=<?=$rows['id']?>">
                                                <?=$rows['name']?></a></h4>

                                                    <p><?=$rows['mota']?></p>
                                                    <div class="d-flex justify-content-between flex-lg-wrap">
                                                      <p class="text-dark fs-5 fw-bold mb-0"><?=$rows['price']?><span> $/ kg</span></p>
...
<!-- 
        ...
        ?>
            <div class="pro-items">
                <img  src="assets/assets/img/<?=$rows['img']?>" alt="" class="img-pro">
                <h3 class="name"><a class="linkpro" href="?act=detailpro&id=<?=$rows['id']?>">
                <?=$rows['name']?></a></h3>
                <p class="price"><?=$rows['price']?><span></span></p>
            </div>
        <?php } ?>
          ...
          <!-- <div class="slidebar">
            <img src="assets/assets/img/slidebar1.jpg" alt="" class="img-slidebar" />
          </div> -->
        </div> -->
