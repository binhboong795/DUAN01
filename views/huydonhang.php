            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <select id="cancelReason" class="form-select" name="lido" required>
                                ...
                                <option value="Đơn hàng được tạo do có sự nhầm lẫn">Đơn hàng được tạo do có sự nhầm lẫn
                                </option>
                    ...
                    <div class="modal-footer">
                        <a href="index.php?act=chitietdonhang"><button type="button" class="btn btn-secondary"
                                data-bs-dismiss="modal">Đóng</button></a>
                        <button type="submit" class="btn btn-primary" id="confirmCancel" name="huydonhang">Xác nhận
                            hủy</button>
                    </div>
        </form>
    </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        confirmCancelButton.addEventListener('click', function() {
            ...
            const cancelOrderModal = bootstrap.Modal.getInstance(document.getElementById(
                'cancelOrderModal'));
