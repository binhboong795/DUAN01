...
<head>
    ...
    <link rel="stylesheet" href="/Duan1/admin/asset/css/style.css.map">
        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="">
                        <a href="index.php?act=thongke"> <i class="fa-solid fa-chart-simple"
                                style="margin-right: 42px;"></i>Thống kê</a>
                    </li>
                ...
                <div class="header-menu">
                    ...
                    <div class="user-area dropdown float-right">
                        ...
                        <div class="user-menu dropdown-menu">
                            ...
                            <a class="nav-link" href="?act=logout"><i class="fa fa-power -off"></i>Logout</a>
                        </div>
                    </div>
